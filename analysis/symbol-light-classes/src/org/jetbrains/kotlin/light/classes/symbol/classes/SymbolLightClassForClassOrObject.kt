...
abstract class SymbolLightClassForClassOrObject(protected val classOrObject: KtClassOrObject) : SymbolLightClassBase(classOrObject.manager),
    ...
    protected fun addMethodsFromCompanionIfNeeded(
        ...
        require(classOrObjectSymbol is KtNamedClassOrObjectSymbol)
