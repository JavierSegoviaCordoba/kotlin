...
internal class SymbolLightAnnotationClass(classOrObject: KtClassOrObject) : SymbolLightInterfaceOrAnnotationClass(classOrObject) {
    init {
    ...
    override fun copy(): SymbolLightClassForClassOrObject = SymbolLightAnnotationClass(classOrObject)
}
