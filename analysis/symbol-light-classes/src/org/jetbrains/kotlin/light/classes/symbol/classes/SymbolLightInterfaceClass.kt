...
internal open class SymbolLightInterfaceClass(classOrObject: KtClassOrObject) : SymbolLightInterfaceOrAnnotationClass(classOrObject) {
    init {
        require(isInterface)
    }
    ...
    override fun copy(): SymbolLightClassForClassOrObject = SymbolLightInterfaceClass(classOrObject)
