...
internal class SymbolLightAnonymousClass(classOrObject: KtClassOrObject) :
    SymbolLightClassForClassOrObject(classOrObject), PsiAnonymousClass {
    ...
    override fun copy() = SymbolLightAnonymousClass(classOrObject)
}
